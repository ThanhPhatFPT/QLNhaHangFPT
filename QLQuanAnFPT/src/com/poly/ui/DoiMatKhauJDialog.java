...
public class DoiMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void doiMatKhau() {
        ...
        String matKhauMoi2 = new String(txtMatKhauMoi2.getPassword()).trim();

        if (manv.isEmpty()) {
            MsgBox.alert(this, "Tên đăng nhập không được bỏ trống!");
        } else if (matKhau.isEmpty()) {
            MsgBox.alert(this, "Mật khẩu hiện tại không được bỏ trống!");
        } else if (matKhauMoi.isEmpty()) {
            MsgBox.alert(this, "Mật khẩu mới không được bỏ trống!");
        } else if (matKhauMoi2.isEmpty()) {
            MsgBox.alert(this, "Xác nhận mật khẩu mới không được bỏ trống!");
